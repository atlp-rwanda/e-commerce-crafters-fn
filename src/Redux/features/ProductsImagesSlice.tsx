...
const productsImagesSlice = createSlice({
  ...
  reducers: {
    ...
    fetchImagesSuccess(state: ProductsImagesState, action: PayloadAction<string[]>) {
      state.loading = false;
      state.images = action.payload;
      state.error = null;
    },
    fetchImagesFailure(state: ProductsImagesState, action: PayloadAction<string>) {
      state.loading = false;
...
export const { fetchImagesRequest, fetchImagesSuccess, fetchImagesFailure } = productsImagesSlice.actions;
