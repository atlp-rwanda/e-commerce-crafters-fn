        ...
        {!isModal ? ("") : (
            ...
            <div className='flex flex-col p-4 w-full gap-[10px]'>
                ...
                <div className='w-full flex flex-row gap-[10px] bg-white p-4 rounded-[12px]'>
                    ...
                    <div>
                        <div onClick={()=> setModal(!isModal)} className='p-2 cursor-pointer hover:scale-105 duration-300 transition-all rounded-[4px] font-[600] font-outfit bg-secondary text-white text-[12px] '>New Products</div>
                    </div>
                </div>
            </div>
        </>
