...
const CartTotals: React.FC<CartTotalsProps> = ({ subTotal, deliveryFeePercentage, discountPercentage, total}) => {
...
<div className="bg-white p-5 rounded-lg w-80 hover:shadow-lg hover:shadow-black font-sans h-[385px]">
  ...
  <div className="mt-5">
    ...
    <div className="flex items-center my-2 text-base pl-0 w-[98%]">
      ...
      <span className="bg-transparent">{subTotal * 0.01 *deliveryFeePercentage} Rwf</span>
    </div>
    <div className="flex items-center my-2 text-base pl-0 w-[98%]">
      <div className="text-gray-400 w-[55%] my-2">Discount</div>
      <span className="bg-transparent">{subTotal * 0.01* discountPercentage} Rwf</span>
    </div>
  ...
  <button className="bg-[#203b57] text-white py-2 px-4 border-none rounded-md cursor-pointer text-base w-full hover:bg-[#004494]">Checkout</button>
</div>
    );
};
