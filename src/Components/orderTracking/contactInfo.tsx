...
export const ContactInfo: React.FC<ContactInfoProps> = ({ address, contactName, email, phoneNumber, orderId}) => {
        ...
        <>
            <div className="flex flex-col gap-12 lg:flex-row justify-between border-b pb-8  font-outfit pl-10 lg:pl-0 lg:pr-20">
                <div className="delivery-address ">
                    ...
                    <p className="text-gray-300">{deliveryAddress.city}, {deliveryAddress.street}</p>
                </div>
