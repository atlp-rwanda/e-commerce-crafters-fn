        ...
        <div className="grid grid-cols-1 justify-center p-5 gap-y-5 items-center md:w-[70%]">
          <div className=" flex justify-center items-center relative">
            <img
              ...
              className=" min-w-[320px] max-w-[100%]  sm:h-[300px] w-full md:w-[95%]-[80%]: h-[200px] md:h-[400px] object-cover"
            />
            <div className="absolute bottom-4 left-2 ">
              <div className=" flex justify-center mt-4">
                {[mainproduct1, mainproduct2, mainproduct3, mainproduct4].map(
                  (image, index) => (
                    <span
                      key={index}
                      className={`h-4 w-4 rounded-full mx-1 ${
                        selectedImage === image ? "bg-[#C9974C]" : "bg-gray-300"
                      }`}
                    />
                  )
                )}
            ...
            <div
              className=" absolute bottom-4 right-2 bg-[#c9974c4b] p-3 rounded-md "
            ...
            >
              <img
                ...
                style={{
                  filter: isWishlist
                    ? "invert(32%) sepia(92%) saturate(2878%) hue-rotate(358deg) brightness(101%) contrast(105%)"
                    : "none",
                }}
              />
            </div>
        ...
        <div className="md:w-1/3 w-full ">
          <div className="flex flex-col gap-6 p-5 mt-10 ">
            ...
            <button
              ...
              className="bg-[#E4A951] p-3 rounded-lg w-full"
            >
              Add to Cart
            </button>
          </div>
