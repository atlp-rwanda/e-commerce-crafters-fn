...
const NewProduct = (property: productProps) => {
    ...
    return (
        <div className='w-full h-full bg-black/20 absolute flex items-center justify-center left-0'>
            <div className='w-1/2 flex flex-col gap-[10px] bg-white p-4 rounded-[12px]'>
