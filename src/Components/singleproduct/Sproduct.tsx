            ...
            <div className='flex justify-center gap-5 md:flex-row md:w-4/5 w=full flex-col'>
                <div className="grid grid-cols-1 justify-center p-5 gap-y-5 items-center md:w-[70%]">
                    <div className='flex justify-center items-center relative'>
                        <img src={selectedImage} alt="Selected product" className='min-w-[320px] max-w-[100%] sm:h-[300px] w-full md:w-[95%] md:h-[400px] h-[200px] object-cover' />
                        ...
                        <div className='absolute bottom-4 right-2 bg-[#c9974c4b] p-3 rounded-md cursor-pointer' onClick={toggleWishlist}>
                            <img
                                src={heart}
                                alt="Wishlist"
                                style={{
