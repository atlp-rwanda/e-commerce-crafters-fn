      ...
      <div className="p-4 bg-white rounded-[12px] flex flex-col gap-[20px] w-full relative">
        <div
          className={`w-full flex flex-col gap-[4px] ${
            isVendorOpen ? "h-[60vh] py-2 px-4" : "h-[0vh]"
          } transition-all duration-300 overflow-hidden shadow-md  bg-gray-50 absolute top-16 left-0 rounded-[6px] `}
        >
          {isLoading
            ? "loading.."
            : vendors.map((vendor: any, index: number) => {
                return (
                  <div
                    onClick={() => handelSelect(vendor)}
                    key={index}
                    className=" cursor-pointer hover:scale-105 transition-all duration-300 flex flex-row gap-[10px]  py-3 items-center bg-white px-2 rounded-[6px]"
                  >
        ...
        {userData?.role !== "vendor" ? (
          <>
            <div className="flex flex-row gap-[10px] items-center justify-between w-full">
              ...
              <div
                ...
                className="w-[40px] h-[40px] bg-primary cursor-pointer hover:scale-75 transition-all duration-200 flex items-center justify-center rounded-[4px]"
              >
          ...
          <h1 className="text-[18px] font-[600] font-outfit uppercase">
