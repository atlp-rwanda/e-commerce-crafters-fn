  ...
  return (
    <section className="bg-primary text-white text-xl sm:text-sm p-24 sm:p-6 md:p-12 lg:p-24 flex flex-col md:flex-row gap-8 md:gap-20 lg:gap-40 font-poppins">
      <div className="mb-8 md:mb-0 md:w-1/2">
        ...
        <div>
          <button className="bg-secondary px-6 py-2 rounded-lg mr-4 mb-4 md:mb-0 md:text-lg">
            {t("Shop Now")}
          </button>
          <button className="bg-blue-900 px-6 py-2 rounded-lg md:text-lg">
            {t("Contact Us")}
          </button>
        </div>
      </div>
      ...
      <div className="md:w-1/2 flex justify-center">
        ...
        {images && images.length > 0 && (
          <img
            ...
            alt="Home Images"
            className="w-full sm:w-auto max-w-md h-60 sm:h-36 md:h-60"
          />
        )}
      </div>
    </section>
