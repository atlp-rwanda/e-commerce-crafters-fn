...
const buttonStyles = "py-1 px-2 min-w-[30px] h-[30px] rounded-md cursor-pointer font-outfit font-medium text-sm md:text-base";
...
const renderPageButton = (page: number) => (
  <button
    ...
    className={`${buttonStyles} ${
      currentPage === page ? "bg-[#EDFBFF] text-[#37C9EE]" : "bg-transparent text-black"
    }`}
